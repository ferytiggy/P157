...
img=ImageTk.PhotoImage(Image.open ("boton.jpg"))


pikachu =ImageTk.PhotoImage(Image.open ("pikachu.jpg"))
bulbasour =ImageTk.PhotoImage(Image.open ("bulbasaur.jpg"))
Charmender =ImageTk.PhotoImage(Image.open ("charmander.jpg"))
Squirtle =ImageTk.PhotoImage(Image.open ("squirtle.jpg"))
Ratata =ImageTk.PhotoImage(Image.open ("rattata.jpg"))
nidoking =ImageTk.PhotoImage(Image.open ("nidoking.jpg"))
jigglypuff =ImageTk.PhotoImage(Image.open ("jigglypuff.jpg"))
meowth =ImageTk.PhotoImage(Image.open ("meowth.jpg"))
Persion =ImageTk.PhotoImage(Image.open ("persian.jpg"))
ajolote = ImageTk.PhotoImage(Image.open("ajolote.jpg"))
abra =ImageTk.PhotoImage(Image.open ("abra.jpg"))
kadabra =ImageTk.PhotoImage(Image.open ("kadabra.jpg"))
Iyvasour =ImageTk.PhotoImage(Image.open ("Ivysaur.jpg"))
...
player2 = Label(root, text = "Jugador 2", bg = "red", fg = "white")
...
pokemon_list = [pikachu,bulbasour,Iyvasour,Charmender,Squirtle,Ratata,jigglypuff,meowth,Persion,abra,kadabra, ajolote]
                
power_list = [200,60,100,50,50,40,70,60,70,30,70,300]
